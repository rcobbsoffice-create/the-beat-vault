  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-white/5 border border-white/10 space-y-4">
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="audit-check" className="text-xs text-gray-400 leading-relaxed cursor-pointer select-none">
            I hereby certify that all samples used in this production are either original, royalty-free, or have been fully cleared for commercial distribution and synchronization. I understand that AudioGenes is a <strong className="text-white">Rights-Aware</strong> platform and misuse can lead to account suspension.
          </label>
        </div>
      ...
      <p className="text-[10px] text-gray-600 text-center italic">
        AudioGenes uses automated fingerprinting to verify declarations against public databases.
      </p>
    </div>
  );
}
