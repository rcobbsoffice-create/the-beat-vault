...
export default function AdminBeatUploadPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // 3. Upload Artwork if present (Manual or AI generated)
      let artworkUrl = null;
        ...
        <View className="relative z-10">
          ...
          <View className="flex-row items-start justify-between">
            ...
            >
              ...
              <Text className="text-gray-300 font-black text-[10px] uppercase tracking-[0.2em]"><Text>Switch </Text><Text className="text-secondary">Bulk</Text></Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
          ...
          >
            ...
            <Text className="text-white font-black text-2xl uppercase italic tracking-tighter text-center">
              {audioFile ? audioFile.name : (
                <><Text>SELECT </Text><Text className="text-secondary">MASTER</Text><Text> TRACK</Text></>
              )}
            </Text>
                  ...
                  <View className="mb-2">
                      ...
                      >
                        {isAnalyzing ? (
                          ...
                          <View className="flex-row items-center gap-2">
                            <Text className="text-purple-400 font-bold uppercase tracking-widest text-xs">✨ Admin Auto-Fill with AI</Text>
                          </View>
                        )}
                      </Button>
                  </View>
